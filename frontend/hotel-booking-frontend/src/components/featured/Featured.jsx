...
const Featured = () => {
  return (
    <div className='featured' >
        ...
        <div class="featuredItem">
            <img className='featuredImg' src="https://cf.bstatic.com/xdata/images/city/600x600/684730.jpg?k=e37b93d88c1fe12e827f10c9d6909a1def7349be2c68df5de885deaa4bc01ee3&o="/>
            <div class="featuredTitle">
                <h1>Channai</h1>
